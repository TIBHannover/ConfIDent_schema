...
| [Event Format](event_format.md) | A property to provide an event format specification, if none of the [Event Types] are applicable to specify the format of an academic event. |
